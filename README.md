...
![npm](https://badgen.net/npm/v/@cldcvr/flow-form-builder) ![license](https://badgen.net/npm/license/@cldcvr/flow-form-builder) ![types](https://badgen.net/npm/types/@cldcvr/flow-form-builder) ![downloads](https://badgen.net//npm/dw/@cldcvr/flow-form-builder) ![build](https://github.com/cldcvr/flow-form-builder/actions/workflows/build.yml/badge.svg) ![release](https://github.com/cldcvr/flow-form-builder/actions/workflows/release.yml/badge.svg) ![CodeQL](https://github.com/cldcvr/flow-form-builder/workflows/CodeQL/badge.svg) ![Snyk Vulnerabilities for npm package](https://img.shields.io/snyk/vulnerabilities/npm/@cldcvr/flow-form-builder?style=flat-square) [![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=sqale_index)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder) [![Bugs](https://sonarcloud.io/api/project_badges/measure?project=cldcvr_flow-form-builder&metric=bugs)](https://sonarcloud.io/summary/new_code?id=cldcvr_flow-form-builder)
